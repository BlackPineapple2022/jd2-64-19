                        ...
                        <c:if test="${user != null}">
                            ...
                            <tr>
                                <td colspan="2"
                                    ...
                                    <form method="POST" action="${pageContext.request.contextPath}/favourite"
                                          target="iframe1">
                                        <input type="hidden" name="id" value="${trip.id}">
                                        <%--<input type="hidden" name="flightDirectId" value="${trip.directFlight.id}">--%>
                                        <%--<input type="hidden" name="flightReturnId" value="${trip.returnFlight.id}">--%>
