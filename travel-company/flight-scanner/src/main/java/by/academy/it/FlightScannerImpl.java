...
public class FlightScannerImpl extends Thread {
    ...
    public FlightScannerImpl(String routeMap, LocalDate startingDate, Integer dayQuantity) {
        this.routeMap = routeMap;
        this.startingDate = startingDate;
        this.dayCount = dayQuantity;
    }

    public FlightScannerImpl(String routeMap, LocalDate startingDate, Integer dayCount, Schedule schedule) {
        this(routeMap,startingDate,dayCount);
        this.schedule = schedule;
    }

    public List<String> parseFlightsRY() {
    ...
    public List<Flight> parseFlightsWIZZ() {
        ...
        while (currentLocalDate.isBefore(finishLocalDate.plusDays(1))) {
            ...
            HttpPost httpPost = new HttpPost("https://be.wizzair.com/10.14.0/Api/search/search");
    ...
    private Map<String, List<String>> getWizzAirCookiesAndTokens() {
        ...
        final HttpUriRequest httpPost = new HttpPost("https://be.wizzair.com/10.14.0/Api/search/search");
