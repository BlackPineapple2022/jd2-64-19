package by.academy.it.travelcompany.travelcompany.servlet.admin.manager.routemap;
...
@Slf4j
@WebServlet(urlPatterns = "/admin/manager/routemap/update")
public class RouteMapUpdateServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RouteMap routeMap = new RouteMap(id,airline,originAirport,destinationAirport,direction);

        RouteMapServiceImpl.getInstance().update(routeMap);
